...
{
    // $query = "SELECT a.serial, b.name, a.amount, DATE_FORMAT(a.depositDate, '%D %M,%Y') as date 
    //           FROM deposit as a, studentinfo as b 
    //           WHERE a.userId = b.userId AND b.isActive='Y'";
    $result = $db->getData("SELECT a.serial,b.name,a.amount,DATE_FORMAT(a.depositDate, '%D %M,%Y') as date from deposit as a, studentinfo as b where a.userId = b.userId and b.isActive='Y'");
    ...
    if ($result !== false) {
        ...
        // Handle the case where query execution fails
