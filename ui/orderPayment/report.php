    ...
    if ($msg == "true") {
        ...
        if ($result !== false) {
            ...
            while ($row = $result->fetch_array()) {
                ...
                if ($row['status'] == 'Done') {
                    $totalPaymentDone = $totalPaymentDone + $row['totalPayment'];
                }
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header titlehms"><i class="fa fa-hand-o-right"></i>Order Report List</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-info-circle fa-fw"></i><i class="fa fa-hand-o-right"></i> Hostel Order Report List View
                    <div class="text-info text-right"><label>Total Payment: </label> <span id="totalPayment"><?php echo $totalPaymentDone; ?> (Status : DONE)</span></div>
