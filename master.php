    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <img alt="HMS" class="pull-left" src="<?php echo $base_url . 'site/images/logo.png' ?>" width="40px"><a class="navbar-brand titlehms" href="<?php echo $base_url . 'dashboard.php' ?>">Hostel Management System</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-maxcdn fa-fw"></i>Order Payment<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo $base_url . 'ui/orderpayment/edit.php' ?>">Student Order View</a>
                                </li>
                                <li>
                                    <a href="<?php echo $base_url . 'ui/orderpayment/report.php' ?>">Report View</a>
                                </li>
