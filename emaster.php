    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <img alt="HMS" class="pull-left" src="<?php echo $base_url . './site/images/logo.png' ?>" width="50px"><a class="navbar-brand titlehms" href="<?php echo $base_url . 'edashboard.php' ?>">Hostel Management System</a>
            </div>
            <!-- /.navbar-header -->
